    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-2 md:px-4 py-3 md:py-4">
        <div className="flex items-center justify-between gap-2">
          ...
          {/* Search Bar */}
          <div className="hidden md:block flex-1 max-w-xs md:max-w-md mx-2 md:mx-8 relative">
        ...
        <div className="md:hidden mt-3">
          <form onSubmit={handleSearch} className="relative">
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-4 pr-12 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200 shadow-sm"
            />
            <button
              type="submit"
              aria-label="Search"
